...
baltimore1999 <- subset(NEI, year == 1999 & fips == 24510);
baltimore2002 <- subset(NEI, year == 2002 & fips == 24510);
baltimore2005 <- subset(NEI, year == 2005 & fips == 24510);
baltimore2008 <- subset(NEI, year == 2008 & fips == 24510);
...
# Generate a bar plot - Plot #2
barplot(c(Emissions1999,Emissions2002,Emissions2005,Emissions2008), names=c(1999,2002,2005,2008), xlab="Years", ylab="Emissions (thousands of units)", main="PM2.5 Emissions in Baltimore MD", col="blue")
