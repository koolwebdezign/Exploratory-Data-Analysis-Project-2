...
Emissions1999 <- round(sum(data1999$Emissions)/1000000, digits=2); # Value in millions of units (rounded to 2 decimals)
Emissions2002 <- round(sum(data2002$Emissions)/1000000, digits=2); # Value in millions of units (rounded to 2 decimals)
Emissions2005 <- round(sum(data2005$Emissions)/1000000, digits=2); # Value in millions of units (rounded to 2 decimals)
Emissions2008 <- round(sum(data2008$Emissions)/1000000, digits=2); # Value in millions of units (rounded to 2 decimals)

# Generate a bar plot - Plot #1
barplot(c(Emissions1999,Emissions2002,Emissions2005,Emissions2008), names=c(1999,2002,2005,2008), xlab="Years", ylab="Emissions (millions of units)", main="PM2.5 Emissions in the United States", col="red")
